...
import { FaMailBulk, FaLinkedin, FaGithub, FaInstagram } from "react-icons/fa";
      ...
      >
        <div className="flex items-center justify-center mb-6">
          ...
          <a
            ...
            href="https://www.linkedin.com/in/jenil-paladiya/"
            target="_blank"
          ...
          <a
            className="inline-block mx-2"
            href="https://github.com/Jenilpaladiya/"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            className="inline-block mx-2"
            href="https://www.instagram.com/kanji.____/"
            target="_blank"
            rel="noopener noreferrer"
          >
